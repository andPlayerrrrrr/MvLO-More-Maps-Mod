...
[CreateAssetMenu(fileName = "BigSpawnTile", menuName = "ScriptableObjects/Tiles/BigSpawnTile", order = 5)]
public class BigSpawnTile : BreakableBrickTile {
